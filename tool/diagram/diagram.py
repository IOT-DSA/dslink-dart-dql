# This was copied from the wonderful work at
# https://github.com/tabatkins/railroad-diagrams/blob/gh-pages/railroad_diagrams.py
# All credits go to Tab Atkins Jr. (tabatkins)
# It was slightly modified to fit our purposes however.
...
class MultipleChoice(DiagramItem):
    ...
    def format(self, x, y, width):
        ...
        DiagramItem('text', text=u"\xe2", attrs={
            "x": x + self.width - 10,
            "y": y + 4,
            "class": "diagram-arrow"
            }).addTo(text)
...
if __name__ == '__main__':
    ...
    exec(open('tool/diagram.js').read())
    _diagram.writeSvg(sys.stdout.write)
